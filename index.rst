...
2019年公開の内容に大幅な加筆・修正を行った Quantum Native Dojo! の書籍版が、2026年4月に講談社より刊行されました。Dojo!の内容を体系的により深く・効率的に身につけることができ、初学者から研究者まで、手元に置いてじっくり学習したい方に最適です。また、これまでカバーされていなかったショアのアルゴリズムや量子誤り訂正といった重要トピックのほか、QSCIアルゴリズムや量子ビット化 (qubitization) などの最新アルゴリズムも追加されました。量子コンピュータを本気で学ぶなら、この一冊。

* `出版社公式サイト <https://www.kodansha.co.jp/book/products/0000424240>`_ （各種ネット書店での購入リンクあり）
* `書籍サポートページ <https://github.com/QunaSys/dojo-book/>`_
